...
def main():
    ...
    subprocess.run("NanoEdgeAI_Emulator.exe NanoEdgeAI_initialize", shell = True)
    ...
    while True:
        if learning_progress < 100:
            try:
                ...
                log_file.write(line)
                log_file.close()
                message = subprocess.check_output("NanoEdgeAI_Emulator.exe NanoEdgeAI_learn --file log.csv --begin 1 --end 1", shell = True)
            ...
            try:
                ...
                log_file.write(line)
                log_file.close()
                message = subprocess.check_output("NanoEdgeAI_Emulator.exe NanoEdgeAI_detect --file log.csv --begin 1 --end 1", shell = True)
